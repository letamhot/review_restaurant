                    ...
                    <div class="card-body">
                        ...
                        <div class="container">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="mb-3 float-left">
                                        <a href="javascript:void(0)" class="btn btn-success btn-icon icon-left"
                                            id="create_new_tag"><i class="fa fa-plus"></i> Add New</a>
                                        <a href="javascript:void(0)" class="btn btn-primary btn-icon icon-left"
                                            id="list_tag" style="display: none;"><i class="fas fa-chevron-left"></i>
                                            Back</a>
                                    </div>
                                    <div class="mb-3 float-right">
                                        <a href="javascript:void(0)" class="btn btn-warning btn-icon icon-left"
                                            id="trash_tag"><i class="fa fa-trash"></i> Trash</a>
                                    </div>
