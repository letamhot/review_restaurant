...
<div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item">All Tags</div>
...
<p class="section-lead">
    You can manage all tags, such as editing, deleting and more.
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="section-header-button">
                    <ul class="nav nav-pills">
                        <li class="nav-item">
                            <a class="nav-link active">All <span class="badge badge-white" id="tag_count"></span></a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="card-body">
                <div class="mb-3 float-left">
                    <a href="javascript:void(0)" class="btn btn-primary btn-icon icon-left" id="create_new_tag"><i
...
<div class="container">
    ...
    <div class="card-body">
        <div class="mb-3 float-left">
            <a href="javascript:void(0)" class="btn btn-success btn-icon icon-left" id="create_new_tag"><i
                    class="fa fa-plus"></i> Add New</a>
            <a href="javascript:void(0)" class="btn btn-primary btn-icon icon-left" id="list_tag"
                style="display: none;"><i class="fas fa-chevron-left"></i> Back</a>
        </div>
        ...
        <div class="table-responsive">
            <div class="justify-content-center">
                <table class="table table-striped datatable" id="tag_datatable">
                    <thead>
