...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <a href="javascript:void(0)" class="btn btn-info ml-3" id="create_new_category">Add New</a>
            <a href="javascript:void(0)" class="btn btn-danger ml-3 pull-right" id="trash_category">Trash</a>
            <a href="javascript:void(0)" class="btn btn-primary ml-3 pull-right" id="list_category">List</a>
            <table class="table table-bordered table-striped datatable" id="category_datatable">
            <thead>
                <tr>
                    <th>No.</th>
                    <th>Name</th>
