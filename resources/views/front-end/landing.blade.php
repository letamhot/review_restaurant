...
<head>
    ...
    <<<<<<< HEAD <title>Review Nhà Hàng</title>
        ...
        >>>>>>> f7e86a19e688fcc310d0dfbc331c8b9d6c1b985d
</head>
...
<body>
    ...
    <main class="main-container">
        ...
        <div class="main-content">
            ...
            <div class="tweet-card">
                ...
                <<<<<<< HEAD <div class="tweet-card__actions-container">
                    <div>
                        <button class="linh-button button-md">
                            <i class="fa fa-bell-o" aria-hidden="true"></i>
                            5947 reactions
                    ...
                    <<<<<<< HEAD <div class="tweet-card">
                        <div class="tweet-card__header">
                            ...
                            <div class="tweet-card__info">
                                ...
                                =======
                                <div class="tweet-card__content">
                                    <a href="" class="tweet-card__title">9 Projects you can do to become a Frontend
                                        Master
                                        in 2020</a>
                                ...
                                <<<<<<< HEAD <div class="tweet-card__content">
                                    <a href="" class="tweet-card__title">9 Projects you can do to become a Frontend
                                        Master
                                        in 2020</a>
    ...
    <<<<<<< HEAD <script>
        ...
        for (i = 0; i < x.length; i++) { x[i].style.display="none" ; } myIndex++; if (myIndex> x.length) {
            myIndex = 1;
            }
