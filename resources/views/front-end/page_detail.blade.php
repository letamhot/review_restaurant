@extends('front-end.layout.web') @push('css')
    ...
    <main class="main-container-detail">
        <aside class="left-side-detail">
            <div class="menu">
                ...
                <br>
                <a style="text-decoration:none" href="javascript:void(0)" class="btn btn-light btn-icon icon-left" id="guest_star"><i style="color: green; padding:10px" class="fa fa-bookmark fa-2x"></i>
                    <span class="badge badge-white">
                        {{ $post_detail->totalStar }}</span></a>
                <br>
                <a href="/login" class=""><i title="Lượt bình luận" style="color: blue;padding:10px "
                        class="fa fa-comments fa-2x"></i></a><span>{{ $post_detail->totalComment }}</span>
                <br> ​ @else ​
                <a style="text-decoration:none" href="javascript:void(0)" data-id='{{ $post_detail->id }}' data-name="like" id="user_like"><i title="yêu thích"
                ...
                <br> ​
                <a style="text-decoration:none" href="javascript:void(0)" data-id='{{ $post_detail->id }}' data-name="star" id="user_star"><i
