...
>>>>>>> 78d088c158b82e81d2510f88b89ce091aa89775b
        ...
        <header>
            <nav class="main-nav">
                ...
                <div>
                    ...
                    <a href="javascript:;" class="linh-nav-icon-button"
            ...
            <div class="tweet-card__background">
                ...
                <img
                    class="mySlides"
                    src="https://indonepaltour.com/img/resort_img.jpeg"
                    style="width: 100%;"
                />
                <img
                    class="mySlides"
                    src="https://globalfoodworld.life/wp-content/uploads/2020/03/T%C3%A1gide-s.jpg"
                    style="width: 100%;"
                />
                <img
                    class="mySlides"
                ...
                <img
                    class="mySlides"
                    src="https://u.realgeeks.media/siliconbeachhomesinla/food.jpg"
                    style="width: 100%;"
                />
            </div>
        </header>
            ...
            <div class="main-content">
                ...
                <div class="tweet-card">
                    ...
                    <div class="tweet-card__content">
                        ...
                        <a href="" class="tweet-card__title"
                        ...
                        <div class="tweet-card__actions-container">
                            ...
                            <div>
                                ...
                                <button
                                    class="linh-button button-md button-silver"
                                >
                                    Save
                                </button>
                            </div>
