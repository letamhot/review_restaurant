...
<div class="container">
    <a id="list" href="javascript:;" class="btn btn-primary" onclick="post.init();">Post List</a>
    <a href="javascript:;" id="create" class="btn btn-success" onclick="post.showModal();" data-toggle="modal"
    data-target="#addpostmodal" ><i class="fa fa-plus"></i> Create</a>
    <a id="trash" href="javascript:;" class="btn btn-info" onclick="post.showTrash();" style="float: right"><i class="fa fa-trash"></i> Trash</a>
